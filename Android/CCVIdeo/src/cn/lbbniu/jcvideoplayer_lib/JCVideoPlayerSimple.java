package cn.lbbniu.jcvideoplayer_lib;
...
public class JCVideoPlayerSimple extends JCVideoPlayer {
    ...
    public int getLayoutId() {
        return UZResourcesIDFinder.getResLayoutID("jc_layout_base");
    }
    ...
    public void onClick(View v) {
        if (v.getId() == UZResourcesIDFinder.getResIdID("fullscreen") && currentState == CURRENT_STATE_NORMAL) {
