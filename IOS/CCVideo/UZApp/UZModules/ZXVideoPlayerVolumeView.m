...
- (void)createVolumeIndicator
{
    ...
    [_volumeImageView setImage:[UIImage imageNamed:@"res_lbbVideo/zx-video-player-volume"]];
...
//        playerView.brightnessIndicatorView.hidden = YES;
    ...
    if (value == 0.0) {
        ...
        if (!self.volumeImageView.accessibilityIdentifier) {
            ...
            self.volumeImageView.image = [UIImage imageNamed:@"res_lbbVideo/zx-video-player-volumeMute"];
        }
    } else {
        ...
        if (self.volumeImageView.accessibilityIdentifier) {
            ...
            self.volumeImageView.image = [UIImage imageNamed:@"res_lbbVideo/zx-video-player-volume"];
        }
    }
