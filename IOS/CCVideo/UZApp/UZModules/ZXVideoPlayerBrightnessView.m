...
- (void)createBrightnessIndicator
{
    ...
    [brightnessImageView setImage:[UIImage imageNamed:@"res_lbbVideo/zx-video-player-brightness"]];
...
//        DWCustomPlayerViewController *playerView = (DWCustomPlayerViewController *)self.superview;
